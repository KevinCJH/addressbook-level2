...
public class Main {
    ...
    private CommandResult executeCommand(Command command)  {
        try {
            ...
            return result;
        }catch(StorageOperationException eso){
            ui.showToUser(Messages.MESSAGE_FILE_READ_ONLY);
            start(new String[0]); //restart program
            return new CommandResult(Messages.MESSAGE_FILE_READ_ONLY);
        } catch (Exception e) {
